...
import devtools from "./svgs/devtools.svg";
import commandPalette from "./svgs/command-palette.svg";
import loadingScreen from "./svgs/loading-screen.svg";
import mainScreen from "./svgs/main-screen.svg";
            ...
            <div className="sticky top-[16.7vh] h-[66.8vh] px-16 text-2xl leading-[1] text-white [&_p]:w-[45rem] [&_p]:max-w-[90%]">
                <motion.div style={{ x, scale }} className="relative h-full">
                    <motion.figure style={{ opacity }} className="h-full">
                        <Image src={mainScreen} className="h-full w-auto" alt="Main Screen"/>
                    </motion.figure>
                ...
                >
                    <span className="text-primary" style={{ color: "black" }}>Preconfigured environments</span>
                    <br />
                ...
                <motion.p
                    ...
                    className="translate-y-centered-offset absolute top-1/2 left-0"
                >
                    <span className="text-primary" style={{ color: "black" }}>Command Pallete</span>
                    <br />
                ...
                <motion.p
                    ...
                    className="translate-y-centered-offset absolute top-1/2 left-0"
                >
                    <span className="text-primary" style={{ color: "black" }}>Devtools</span>
                    <br />
